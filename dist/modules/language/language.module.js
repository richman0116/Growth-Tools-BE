    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: language_schema_1.LANGUAGES_MODEL, schema: language_schema_1.LanguagesSchema },
            ]),
        ],
        controllers: [language_controller_1.LanguageController],
        providers: [language_repository_1.LanguagesRepository, language_service_1.LanguageService],
        exports: [language_repository_1.LanguagesRepository, language_service_1.LanguageService],
    })
], LanguageModule);
