...
export declare class RolesRepository extends BaseAbstractRepository<IRolesDoc> implements RolesRepositoryInterface {
    private readonly rolesModel;
    constructor(rolesModel: Model<IRolesDoc>);
