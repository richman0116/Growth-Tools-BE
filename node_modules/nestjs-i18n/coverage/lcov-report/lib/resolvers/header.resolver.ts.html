...
<head>
    <title>Code coverage report for lib/resolvers/header.resolver.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/resolvers</a> header.resolver.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { I18nResolver } from '../index';
...
export class HeaderResolver implements I18nResolver {
  constructor(
    @I18nResolverOptions()
    private keys: string[] = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span>
  ) {}
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (req) {
      for (const key of this.keys) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (key === 'accept-language') {
