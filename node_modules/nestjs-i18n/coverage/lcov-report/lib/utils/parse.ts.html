...
<head>
    <title>Code coverage report for lib/utils/parse.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/utils</a> parse.ts</h1>
        <div class='clearfix'>
...
<a name='L52'></a><a href='#L52'>52</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
...
<span class="cstat-no" title="statement not covered" >          return (await exists(path.join(dirPath, f))) &amp;&amp; pattern.test(f);</span>
        } else {
...
<span class="cstat-no" title="statement not covered" >        return false;</span>
  ...
  ).map(f =&gt; path.join(dirPath, typeof f === 'string' ? <span class="branch-0 cbranch-no" title="branch not covered" >f </span>: f.name));
};
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Fri Mar 13 2020 16:45:36 GMT+0100 (Central European Standard Time)
            </div>
        </div>
