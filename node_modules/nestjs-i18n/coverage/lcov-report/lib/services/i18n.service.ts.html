...
<head>
    <title>Code coverage report for lib/services/i18n.service.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/services</a> i18n.service.ts</h1>
        <div class='clearfix'>
...
<a name='L103'></a><a href='#L103'>103</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Inject, Injectable, Logger } from '@nestjs/common';
...
&nbsp;
    if (translation &amp;&amp; (args || (args instanceof Array &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >args.length &gt; 0)</span>)) {
      translation = format(
        translation,
        ...(args instanceof Array ? args || <span class="branch-1 cbranch-no" title="branch not covered" >[] </span>: [args]),
      );
    }
...
&nbsp;
  public async refresh() {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (translations instanceof Observable) {
<span class="cstat-no" title="statement not covered" >      this.translationsSubject.next(</span>
...
<span class="cstat-no" title="statement not covered" >      this.languagesSubject.next(await languages.pipe(take(1)).toPromise());</span>
    } else {
