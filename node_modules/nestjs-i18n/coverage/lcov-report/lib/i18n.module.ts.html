...
<head>
    <title>Code coverage report for lib/i18n.module.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> i18n.module.ts</h1>
        <div class='clearfix'>
...
<a name='L315'></a><a href='#L315'>315</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
...
<span class="cstat-no" title="statement not covered" >          logger.error('parsing translation error', e);</span>
        }
...
&nbsp;
    const resolversProvider = {
      ...
      useValue: options.resolvers || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span>
    };
&nbsp;
    return {
      module: I18nModule,
...
&nbsp;
  private static createAsyncOptionsProvider(
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (options.useFactory) {
      return {
        provide: I18N_OPTIONS,
...
<span class="cstat-no" title="statement not covered" >    return {</span>
      provide: I18N_OPTIONS,
      useFactory: <span class="fstat-no" title="function not covered" >async </span>(optionsFactory: I18nOptionsFactory) =&gt;
<span class="cstat-no" title="statement not covered" >        await optionsFactory.createI18nOptions(),</span>
  ...
  private static createAsyncTranslationProvider(): Provider {
    return {
      ...
      useFactory: async (
        ...
        try {
          const translation = await parser.parse();
          <span class="missing-if-branch" title="if path not taken" >I</span>if (translation instanceof Observable) {
<span class="cstat-no" title="statement not covered" >            translation.subscribe(translationsSubject);</span>
          } else {
  ...
  private static createAsyncLanguagesProvider(): Provider {
    return {
      ...
      useFactory: async (
        ...
        try {
          const languages = await parser.languages();
          <span class="missing-if-branch" title="if path not taken" >I</span>if (languages instanceof Observable) {
<span class="cstat-no" title="statement not covered" >            languages.subscribe(languagesSubject);</span>
          } else {
