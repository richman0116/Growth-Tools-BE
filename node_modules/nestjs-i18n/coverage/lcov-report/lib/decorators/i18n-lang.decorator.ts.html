...
<head>
    <title>Code coverage report for lib/decorators/i18n-lang.decorator.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/decorators</a> i18n-lang.decorator.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >      throw Error(`context type: ${context.getType()} not supported`);</span>
    }
&nbsp;
    return ctx.i18nLang;
  },
