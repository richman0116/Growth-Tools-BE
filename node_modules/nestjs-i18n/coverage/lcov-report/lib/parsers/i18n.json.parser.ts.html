...
<head>
    <title>Code coverage report for lib/parsers/i18n.json.parser.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/parsers</a> i18n.json.parser.ts</h1>
        <div class='clearfix'>
...
<a name='L155'></a><a href='#L155'>155</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { I18nParser } from './i18n.parser';
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(await exists(i18nPath))) {
<span class="cstat-no" title="statement not covered" >      throw new Error(`i18n path (${i18nPath}) cannot be found`);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.options.filePattern.match(/\*\.[A-z]+/)) {
